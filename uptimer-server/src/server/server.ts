...
import { mergedGraphQLSchema } from '../graphql/schema';
...
export default class MonitorServer {
    ...
    constructor(app: Express) {
        ...
        const schema: GraphQLSchema = makeExecutableSchema({ typeDefs: mergedGraphQLSchema, resolvers });
    ...
    private healthRoute(app: Express): void {
        app.get('/health', (_req: Request, res: Response) => {
            res.status(200).send('Uptimer monitoring service is healthy');
        });
    }
